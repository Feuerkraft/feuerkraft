...
- [ ] Fix `stb_image.h` fixed-output hash in flake and enable `feuerkraft-android`
...
- [ ] WASM datadir: ensure `path_manager` finds `/data` after preload
...
# nix build .#feuerkraft-android    # after stb hash + NDK pipeline verified
