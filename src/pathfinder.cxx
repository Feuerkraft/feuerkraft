//  $Id: pathfinder.cxx,v 1.5 2003/04/29 16:34:45 grumbel Exp $
//
...
bool
Pathfinder::is_path_node(int x, int y)
{
  if (path.empty()) 
    return false;
  else
...
Node&
Pathfinder::resolve_parent(Node& node)
{
...
int main()
{
  ...
  if (pathfinder.get_state() != Pathfinder::PATH_FOUND)
    {
...
// Local Variables:
// compile-command: "g++-3.2 -DTESTME -Wall -O0 pathfinder.cxx  -o pathfinder -lclanCore"
// End:
